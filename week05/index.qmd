...
In this lesson, students will be introduced to sentiment analysis, specifically applied to evaluating general positivity or negativity in football managers' statements about match outcomes. **[SUGGESTED ADDITION]** Learn when AI excels at text analysis vs. where human judgment remains essential, and develop skills in prompt engineering for consistent text classification.
...
- **[SUGGESTED ADDITION]** How did multi-table workflows change your research questions?
