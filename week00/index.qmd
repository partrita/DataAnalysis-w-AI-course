...
- You can you almost all of this for other languages like SQL, Stata or Julia.
...
-   **Specify output format:** "Save as PNG for publication" or "Return as tidy data table" or "give back markedown (latex) text with eqautions"
...
**Getting Started:** - [GitHub Student Pack](https://education.github.com/pack) - Free Copilot access - [Cursor AI](https://www.cursor.com/) - AI-first code editor - [OpenAI Codex Cookbook](https://github.com/openai/openai-cookbook) - Advanced prompting examples
