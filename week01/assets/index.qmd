...
::: {.hero-section}
::: {.container}
# Week 1: LLM Review {.hero-title}
Introduction to Large Language Models and their applications in data analysis {.hero-subtitle}
:::
:::
...
:::
::: {.card-body}
- [Which AI Model to Choose?](assets/which-ai.qmd) - Updated guide for 2025
...
**Your Mission:** Reproduce this chart as accurately as possible in the shortest time using AI assistance.
...
[Full Assignment Details](../assignments/assignment_01.qmd){.assignment-badge}
:::
...
- See [AI Model Comparison Guide](assets/which-ai.qmd) for detailed recommendations
